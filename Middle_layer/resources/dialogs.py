...
class Dialogs(object):
    ...
    def load_dialogs(self):
        ...
        self.yes_beginning = ["^start(animations/Stand/Gestures/Hysterical_1)That's great\\pau = 200\\, then we can start!^wait(animations/Stand/Gestures/Hysterical_1)", "Cool!, let's talk then", "^start(animations/Stand/Gestures/Hysterical_1)Im happy to hear that you want to talk with me!^wait(animations/Stand/Gestures/Hysterical_1)"] 
        ...
        self.peoplebutmain = ["Seems like a crowded place!. However\\pau = 200\\, only a few people seems important in this photo", "I can see a lot of people, but I think  there is a few important people"]
        ...
        self.Hello = ['Hey! Nice to meet you \\pau = 200\\', 'Hi! Before starting \\pau = 200\\', 'Hello, Nice to meet you \\pau = 200\\', "Hello! Before starting the session\\pau = 200\\"]

        self.calibration_face = ["I will do quick calibrations, Could you look at my face please?", "I will do some calibrations. Could you look at my face please?"]
